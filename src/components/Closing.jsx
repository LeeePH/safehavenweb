...
const fireworks = "/assets/fireworks.gif";
const christmas = "/assets/christmas.gif";
    ...
    <div className="min-h-screen w-full bg-black/20 flex flex-col items-center justify-center">
      <div className="relative h-screen w-full overflow-hidden flex flex-col items-center justify-center">
        ...
        <div className="w-[90%] max-w-[400px] flex flex-col items-center">
          ...
          <div className="z-10 w-full max-h-[50vh] sm:max-h-[60vh] overflow-y-auto px-4 mb-6 rounded-lg">
            <p className="text-white text-center text-xl font-semibold drop-shadow-lg pb-2">
